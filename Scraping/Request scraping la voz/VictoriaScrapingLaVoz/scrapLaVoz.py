...
url_lista = "https://www.lavoz.com.ar/busqueda/lo-ultimo/"
...
json_file_name = os.path.join(current_dir, "lo-ultimo.json")
csv_file_name = os.path.join(current_dir, "lo-ultimo.csv")
